    ...
    "inline-flex items-center justify-center whitespace-nowrap font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-95",
    {
        variants: {
            variant: {
                ...
                ghost: "hover:bg-muted/60 transition-colors",
                link: "text-primary underline-offset-4 hover:underline",
                success: "bg-success text-success-foreground hover:bg-success/90 hover:shadow-md active:shadow-sm",
                warning: "bg-warning text-warning-foreground hover:bg-warning/90 hover:shadow-md active:shadow-sm",
                danger: "bg-error text-error-foreground hover:bg-error/90 hover:shadow-md active:shadow-sm",
                premium: "bg-gradient-to-r from-primary to-primary/80 text-primary-foreground hover:shadow-lg hover:shadow-primary/30 active:shadow-md",
            },
            size: {
